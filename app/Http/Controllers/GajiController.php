...
class GajiController extends Controller
{
    ...
    {
        $gaji = DB::table('gajis')
                ->join('jabatans','gajis.id','=','jabatans.id')
                ->join('cabangs','gajis.id','=','cabangs.id')
                ->join('departemens','gajis.id','=','departemens.id')
                ->join('lemburs','gajis.id','=','lemburs.id')
                ->join('karyawans','gajis.id','=','karyawans.id')
                ->select('gajis.*','jabatans.nama_jabatan','jabatans.tunjangan_jabatan',
                        'cabangs.nama_cabang','cabangs.uang_makan',
                    'lemburs.total_uang_lembur','karyawans.nama','karyawans.tunjangan_keluarga','karyawans.gaji_pokok','karyawans.nama_bank','karyawans.nomor_rekening',
