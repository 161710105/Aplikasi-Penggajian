...
class KaryawanController extends Controller
{
    ...
    {
        $karyawans = Karyawan::with('Jabatan','Cabang','Departemen')->get();
    ...
    public function create()
    {
        ...
        return view('karyawan.create',compact('departemen','cabang','jabatan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $karyawan->kode_cabang = $request->kode_cabang;
    ...
    public function show($id)
    {
        ...
        $cabang = Cabang::all();
        $selectedCabang = Karyawan::findOrFail($id)->kode_cabang;
        $departemen = Departemen::all();
        $selectedDepartemen = Karyawan::findOrFail($id)->kode_departemen;
        
        return view('karyawan.show',compact('karyawan','jabatan','selectedJabatan','cabang','selectedCabang','departemen','selectedDepartemen'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('karyawan.edit',compact('karyawan','jabatan','selectedJabatan','cabang','selectedCabang','departemen','selectedDepartemen'));
    }
