			  ...
			  <div class="panel-body">
			  	<form action="{{ route('karyawan.store') }}" method="post" id="form_karyawan" >
			  		...
			  		<div class="form-group {{ $errors->has('status_pernikahan') ? ' has-error' : '' }}">
			  			...
			  			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
			  			<input type="radio" name="status_pernikahan" class="form-check-input"  value="Kawin">Kawin
			  			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  			<input type="radio" name="status_pernikahan" class="form-check-input"  value="Belum Kawin">Belum Kawin
			  		...
			  		<div class="form-group {{ $errors->has('jumlah_anak') ? ' has-error' : '' }}">
			  			...
			  			<input id="jumlah_anak" type="number" name="jumlah_anak" class="form-control prc"  required>
			  		...
			  		<div class="form-group {{ $errors->has('tunjangan_keluarga') ? ' has-error' : '' }}">
			  			...
			  			<input id="tunjangan_keluarga" type="number" name="tunjangan_keluarga" class="form-control"  readonly>
